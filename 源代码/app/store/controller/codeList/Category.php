...
use app\store\model\codeList\Category as listCategoryModel;
...
class category extends Controller
{
    ...
    {
        $detail = listCategoryModel::detail($categoryId);
    ...
    {
        // 文章详情
        $model = listCategoryModel::detail($categoryId);
        // 更新记录
