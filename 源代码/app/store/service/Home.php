...
class Home extends BaseService
{
    ...
    public function __construct()
    {
        ...
        $this->VipLogModel = new VipLogModel;
    }
    ...
    {
        return $this->VipLogModel->getVipLogTotalPrice($day, $day)/100;
    }
    ...
    {
        return number_format($this->VipLogModel->getPayVipLogUserTotal($day));
    }
    ...
    {
        return number_format($this->VipLogModel->getPayOrderTotal($day, $day));
    }
    ...
    {
        return number_format($this->VipLogModel->getNotPayOrderTotal());
    }
