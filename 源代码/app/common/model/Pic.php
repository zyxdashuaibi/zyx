...
class Pic extends BaseModel
{
    ...
    public function category()
    {
        ...
        return $this->BelongsTo("app\\{$module}\\model\\pic\\Category", 'category_id');
    }
     ...
     */
    public static function detail(int $picId, array $with = [])
    {
        return self::get($picId, $with);
    }
}
